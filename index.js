...
mongoose.connect("mongodb+srv://HarishEcom:Hkbtsals@cluster0.r0nxrej.mongodb.net/e-commerce")
...
app.post('/signup',async(req,res)=>{
    ...
    if(check){
        return res.status(400).json({success:false,erros: "user already existed"})
    }
    let cart = {};
    for(let i=0;i<300;i++){
        cart[i]=0;
